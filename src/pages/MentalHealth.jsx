  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      const aiReply = {
        id: Date.now() + 1,
        sender: 'ai',
        text: "Saya mengerti. Mari kita coba teknik relaksasi singkat selama 3 menit. Saya juga mendeteksi bahwa detak jantung Anda berada di 88 BPM, yang menunjukkan kondisi siaga ringan.",
        time: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })
      };
