          ...
          <div className="bg-white rounded-[40px] p-10 max-w-2xl w-full relative z-10 animate-in zoom-in-95 duration-300 shadow-2xl">
            ...
            <div className="space-y-6">
              <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100 flex justify-between items-center">
                <div>
                  <p className="text-xs font-bold text-slate-400 uppercase mb-1">Skor Keseluruhan</p>
                  <p className="text-4xl font-bold text-primary">88/100</p>
                </div>
                <div className="text-right">
                  <p className="text-[10px] font-bold text-green-500 bg-green-50 px-3 py-1 rounded-full uppercase">Kondisi Baik</p>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-primary/5 rounded-2xl border border-primary/10">
                  <p className="text-[10px] font-bold text-primary uppercase mb-2">Hidrasi</p>
                  <div className="h-1.5 w-full bg-slate-200 rounded-full"><div className="h-full bg-primary w-[90%] rounded-full"></div></div>
                </div>
                <div className="p-4 bg-orange-50 rounded-2xl border border-orange-100">
                  <p className="text-[10px] font-bold text-orange-500 uppercase mb-2">Minyak (Sebum)</p>
                  <div className="h-1.5 w-full bg-slate-200 rounded-full"><div className="h-full bg-orange-400 w-[45%] rounded-full"></div></div>
                </div>
              </div>
              <p className="text-sm text-on-surface-variant leading-relaxed">
                "Berdasarkan analisis deep learning, kulit Anda menunjukkan tingkat hidrasi yang sangat baik. Kami mendeteksi sedikit inflamasi di area dahi, disarankan untuk menggunakan shooting gel malam ini."
              </p>
      ...
      <div className="grid grid-cols-12 gap-6">
          ...
          <div className="flex justify-between items-start mb-6 relative z-10">
            <div>
              ...
              <div className="flex items-baseline gap-2 mt-4">
                <span className="text-8xl font-bold text-primary tracking-tighter">88</span>
        ...
        <div className="col-span-12 lg:col-span-4 flex flex-col gap-6">
          <div className="bg-white rounded-[32px] p-8 shadow-sm border border-slate-100">
            ...
            <h4 className="text-xl font-bold text-on-surface mb-2">Status Mental</h4>
            <p className="text-on-surface-variant text-sm leading-relaxed">Anda terlihat tenang hari ini. Luangkan 5 menit untuk meditasi pagi.</p>
          </div>
